  ...
  return (
    <div className={`${styles.footer} `}>
      <div className={`d-flex justify-content-evenly align-items-center m-auto ${styles.width}`}>
        ...
        href='https://bsattam.github.io/Portfolio/' target="_blank">
          Created By: Sattam Bandyopadhyay
        </a>
        <IconContext.Provider value={{color: '#8bb4b2'}}>
          <a href='https://www.linkedin.com/in/sattam-bandyopadhyay/' target="_blank"><BsLinkedin/></a>
          <a href='https://github.com/bsattam' target="_blank"><BsGithub/></a>
